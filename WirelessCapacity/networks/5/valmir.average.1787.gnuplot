...
set output "graph.1787.0.average.pdf"
...
set origin 0,0.22
set size 1,0.11
plot 'graph.1787.0.dot.node.average.minMaxDeviation.data' using 4:2 title "average.minMaxDeviation" with lines lc 1
set origin 0,0.11
set size 1,0.11
...
set origin 0,0.55
set size 1,0.11
plot 'graph.1787.0.dot.node.average.maxDeviation.data' using 4:2 title "average.maxDeviation" with lines lc 2
set origin 0,0.44
set size 1,0.11
...
set origin 0,0.88
set size 1,0.11
plot 'graph.1787.0.dot.node.average.stdDeviation.data' using 4:2 title "average.stdDeviation" with lines lc 3
set origin 0,0.77
set size 1,0.11
